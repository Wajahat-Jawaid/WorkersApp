...
Java_com_wajahat_workersapp_di_RetrofitModule_getBaseURL(JNIEnv *env, jobject instance) {

    return (*env)->NewStringUTF(env, "https://pilot.wakecap.com/api/sites/10010001/");
}

JNIEXPORT jstring JNICALL
Java_com_wajahat_workersapp_di_NetworkModule_getAuthHeader(JNIEnv *env, jobject instance) {
...
JNIEXPORT jstring JNICALL
Java_com_wajahat_workersapp_di_NetworkModule_getContentTypeHeader(JNIEnv *env, jobject instance) {

    return (*env)->NewStringUTF(env, "application/x-www-form-urlencoded");
}

JNIEXPORT jstring JNICALL
Java_com_wajahat_workersapp_di_NetworkModule_getRequestedWithHeader(JNIEnv *env, jobject instance) {

    return (*env)->NewStringUTF(env, "XMLHttpRequest");
}